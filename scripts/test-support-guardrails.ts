...
assert.equal(extractRegisterIdentifiant('quoi ?'), null);
assert.equal(extractRegisterIdentifiant('quels sont les identifiants'), null);
assert.equal(extractRegisterIdentifiant('mon identifient est Mathys_67'), 'mathys_67');

-- ============================================================
-- SYSTÈME FELITZ BANK & COMPAGNIES
...
-- ----- 2) Modifier compagnies pour PDG et paramètres -----
...
-- ----- 3) Table employés de compagnies -----
...
-- ----- 6) Transactions Felitz (historique) -----
...
-- ----- 8) Inventaire personnel d'avions -----
...
-- ----- 12) Modifier plans_vol pour infos commerciales -----
...
BEGIN
  IF NEW.vban IS NULL THEN
    -- Générer VBAN unique pour entreprise
    LOOP
    ...
    VALUES ('entreprise', NEW.id, new_vban, 0);
  END IF;

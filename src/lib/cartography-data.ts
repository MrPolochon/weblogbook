...
export const DEFAULT_FIR_ZONES: FIRZone[] = [
  ...
  { id: 'rockford_fir', code: 'ROCKFORD', name: 'ROCKFORD FIR', points: [{ x: 327, y: 770 }, { x: 327, y: 770 }, { x: 456, y: 770 }, { x: 456, y: 770 }, { x: 457, y: 637 }, { x: 538, y: 630 }, { x: 564, y: 589 }, { x: 564, y: 589 }, { x: 621, y: 572 }, { x: 618, y: 552 }, { x: 618, y: 552 }, { x: 604, y: 497 }, { x: 603, y: 497 }, { x: 590, y: 469 }, { x: 681, y: 434 }, { x: 681, y: 434 }, { x: 697, y: 376 }, { x: 697, y: 376 }, { x: 650, y: 334 }, { x: 650, y: 334 }, { x: 626, y: 253 }, { x: 626, y: 253 }, { x: 626, y: 252 }, { x: 389, y: 251 }, { x: 389, y: 251 }, { x: 367, y: 269 }, { x: 367, y: 269 }, { x: 367, y: 269 }, { x: 328, y: 357 }, { x: 323, y: 404 }, { x: 267, y: 416 }, { x: 267, y: 416 }, { x: 265, y: 574 }, { x: 327, y: 639 }, { x: 327, y: 639 }], color: 'rgba(255,200,0,0.15)', borderColor: '#ffc800' },
  ...
  { id: 'cyprus_f_fir', code: 'CYPRUS F', name: 'Cyprus FIR', points: [{ x: 462, y: 774 }, { x: 462, y: 774 }, { x: 461, y: 641 }, { x: 461, y: 641 }, { x: 540, y: 634 }, { x: 540, y: 634 }, { x: 565, y: 592 }, { x: 565, y: 592 }, { x: 625, y: 574 }, { x: 625, y: 574 }, { x: 622, y: 552 }, { x: 622, y: 552 }, { x: 778, y: 515 }, { x: 778, y: 515 }, { x: 822, y: 560 }, { x: 822, y: 560 }, { x: 1001, y: 597 }, { x: 1001, y: 597 }, { x: 1001, y: 777 }, { x: 1001, y: 777 }], color: 'rgba(255,200,0,0.15)', borderColor: '#ffc800' },
  ...
  { id: 'grindavi_fir', code: 'GRINDAVI', name: 'Grindavik FIR', points: [{ x: 33, y: 484 }, { x: 33, y: 484 }, { x: 155, y: 499 }, { x: 155, y: 499 }, { x: 262, y: 545 }, { x: 262, y: 545 }, { x: 262, y: 410 }, { x: 262, y: 410 }, { x: 321, y: 399 }, { x: 321, y: 399 }, { x: 325, y: 357 }, { x: 325, y: 357 }, { x: 362, y: 269 }, { x: 361, y: 269 }, { x: 293, y: 31 }, { x: 34, y: 31 }], color: 'rgba(255,200,0,0.15)', borderColor: '#ffc800' },
...
export const DEFAULT_WAYPOINTS: Waypoint[] = [
  { code: 'DEBUG', x: 87.8, y: 76.7 },
  { code: 'JACKI', x: 77.5, y: 76.7 },
  { code: 'BOBUX', x: 82.1, y: 83 },
  { code: 'NUBER', x: 94, y: 84.4 },
  { code: 'JAZZR', x: 87.6, y: 90.3 },
  { code: 'MUONE', x: 81.2, y: 90 },
  { code: 'ALTRS', x: 78.6, y: 97.1 },
  { code: 'MASEV', x: 72.3, y: 97.2 },
  { code: 'FORCE', x: 66.5, y: 97.2 },
  { code: 'BURGER', x: 54.3, y: 98.5 },
  { code: 'REAPR', x: 49.6, y: 92.1 },
  { code: 'FORIA', x: 56.1, y: 90.1 },
  { code: 'AQWRT', x: 62.9, y: 83.9 },
  { code: 'LAZER', x: 56.7, y: 76.7 },
  { code: 'GRASS', x: 65, y: 72.8 },
  { code: 'RENTS', x: 71, y: 69.3 },
  { code: 'WELLS', x: 70.6, y: 20.7 },
  { code: 'SQUID', x: 79.9, y: 21 },
  { code: 'ZESTA', x: 88.1, y: 24.1 },
  { code: 'KELLA', x: 78.1, y: 29 },
  { code: 'NOONU', x: 74.1, y: 28.7 },
  { code: 'SISTA', x: 76.6, y: 35.7 },
  { code: 'TALIS', x: 71.4, y: 36.6 },
  { code: 'STRAX', x: 60.3, y: 30.6 },
  { code: 'TINDR', x: 58.7, y: 25 },
  { code: 'UDMUG', x: 90.4, y: 33.3 },
  { code: 'NIKON', x: 43.8, y: 8.5 },
  { code: 'CHILY', x: 55.9, y: 10.7 },
  { code: 'LETSE', x: 49.6, y: 16.1 },
  { code: 'HONDA', x: 54.4, y: 19.1 },
  { code: 'KNIFE', x: 54.2, y: 26.9 },
  { code: 'ONDER', x: 49.4, y: 29 },
  { code: 'PIPER', x: 42.6, y: 26.8 },
  { code: 'GULEG', x: 36.1, y: 25.5 },
  { code: 'ASTRO', x: 41.1, y: 21 },
  { code: 'SHIBA', x: 38.9, y: 13.5 },
  { code: 'SHELL', x: 33.5, y: 7.8 },
  { code: 'BULLY', x: 25.3, y: 16.5 },
  { code: 'EURAD', x: 30.3, y: 26.6 },
  { code: 'FROOT', x: 20.4, y: 24.5 },
  { code: 'BLANK', x: 32.1, y: 33 },
  { code: 'YOUTH', x: 26.1, y: 38.6 },
  { code: 'THENR', x: 20.2, y: 34.6 },
  { code: 'ACRES', x: 11.7, y: 36.5 },
  { code: 'UNWAIS', x: 7.6, y: 41.7 },
  { code: 'FRANK', x: 8.1, y: 49.6 },
  { code: 'GUESS', x: 29.2, y: 47.3 },
  { code: 'CELAR', x: 22.2, y: 53.2 },
  { code: 'THACC', x: 8.1, y: 58.6 },
  { code: 'SHREK', x: 15.2, y: 59.6 },
  { code: 'SPACE', x: 22.5, y: 61.4 },
  { code: 'RENDR', x: 40.9, y: 32.5 },
  { code: 'PROBE', x: 44.2, y: 36.8 },
  { code: 'DINER', x: 53.8, y: 37.6 },
  { code: 'WELSH', x: 41, y: 43.1 },
  { code: 'INDEX', x: 45.4, y: 47.1 },
  { code: 'GAVIN', x: 55.6, y: 49.4 },
  { code: 'SILVA', x: 64.7, y: 49.7 },
  { code: 'OCEEN', x: 59.8, y: 54 },
  { code: 'ROSMO', x: 82.1, y: 37.7 },
  { code: 'DUNKS', x: 73, y: 41.9 },
  { code: 'CAMEL', x: 67.8, y: 41.4 },
  { code: 'CYRIL', x: 72, y: 48.3 },
  { code: 'DOGGO', x: 79, y: 55.4 },
  { code: 'MORRD', x: 90.5, y: 45.6 },
  { code: 'ABSRS', x: 93.8, y: 54.6 },
  { code: 'BILLO', x: 87.7, y: 59.3 },
  { code: 'JUSTY', x: 81.1, y: 64.7 },
  { code: 'ANYMS', x: 62.9, y: 65.3 },
  { code: 'CHAIN', x: 93.8, y: 67.6 },
  { code: 'ENDER', x: 35.9, y: 49.6 },
  { code: 'SETHR', x: 53.9, y: 57.1 },
  { code: 'JAMSI', x: 57.2, y: 69.1 },
  { code: 'BEANS', x: 30.1, y: 63.2 },
  { code: 'PARTS', x: 35.9, y: 63.7 },
  { code: 'WAREZ', x: 35.9, y: 69.5 },
  { code: 'CRACK', x: 35.9, y: 81.3 },
  { code: 'INTER', x: 40.8, y: 81.7 },
  { code: 'DEATH', x: 34.8, y: 90.5 },
  { code: 'ROBUX', x: 24.7, y: 96.4 },
  { code: 'HOGGS', x: 28.2, y: 87.7 },
  { code: 'ALDER', x: 29.2, y: 81.2 },
  { code: 'SEEKS', x: 22.5, y: 73.4 },
  { code: 'PACKT', x: 13, y: 79.9 },
  { code: 'STACK', x: 20.4, y: 83.5 },
  { code: 'WASTE', x: 12.7, y: 88.6 },
  { code: 'HECKS', x: 7.6, y: 78 },
  { code: 'HACKE', x: 5.4, y: 71.3 },
  { code: 'DACKD', x: 9.3, y: 67.5 },
  { code: 'GEORG', x: 15.6, y: 70 },
];

...
export const DEFAULT_ISLANDS: Island[] = [
  ...
  { id: 'keflavik', name: 'Keflavik', points: [{ x: 172, y: 338 }, { x: 175, y: 338 }, { x: 179, y: 341 }, { x: 183, y: 342 }, { x: 186, y: 345 }, { x: 188, y: 349 }, { x: 188, y: 354 }, { x: 186, y: 358 }, { x: 181, y: 359 }, { x: 177, y: 358 }, { x: 173, y: 358 }, { x: 170, y: 358 }, { x: 171, y: 354 }, { x: 169, y: 351 }, { x: 168, y: 348 }, { x: 169, y: 345 }, { x: 170, y: 344 }, { x: 170, y: 342 }, { x: 170, y: 342 }], fill: '#4a7a5a', stroke: '#1a3d2a' },
  { id: 'keflavik_south', name: 'Keflavik south', points: [{ x: 180, y: 377 }, { x: 181, y: 375 }, { x: 182, y: 372 }, { x: 183, y: 370 }, { x: 185, y: 368 }, { x: 185, y: 366 }, { x: 184, y: 364 }, { x: 181, y: 362 }, { x: 178, y: 362 }, { x: 176, y: 364 }, { x: 173, y: 366 }, { x: 173, y: 371 }, { x: 173, y: 371 }, { x: 172, y: 373 }, { x: 172, y: 373 }, { x: 178, y: 373 }, { x: 178, y: 373 }], fill: '#4a7a5a', stroke: '#1a3d2a' },
...
export const DEFAULT_FIR_ZONES: FIRZone[] = [
  ...
  { id: 'cyprus f_fir', code: 'CYPRUS F', name: 'Cyprus FIR', points: [{ x: 534, y: 772 }, { x: 532, y: 648 }, { x: 631, y: 604 }, { x: 625, y: 574 }, { x: 625, y: 574 }, { x: 622, y: 552 }, { x: 622, y: 552 }, { x: 778, y: 515 }, { x: 778, y: 515 }, { x: 822, y: 560 }, { x: 822, y: 560 }, { x: 1001, y: 597 }, { x: 1001, y: 597 }, { x: 1001, y: 777 }, { x: 1001, y: 777 }], color: 'rgba(255,200,0,0.15)', borderColor: '#ffc800' },
  ...
  { id: 'keflavik_fir', code: 'KEFLAVIK', name: 'Keflavik FIR', points: [{ x: 33, y: 484 }, { x: 33, y: 484 }, { x: 155, y: 499 }, { x: 155, y: 499 }, { x: 262, y: 545 }, { x: 262, y: 545 }, { x: 263, y: 417 }, { x: 325, y: 357 }, { x: 325, y: 357 }, { x: 362, y: 269 }, { x: 361, y: 269 }, { x: 293, y: 31 }, { x: 34, y: 31 }], color: 'rgba(255,200,0,0.15)', borderColor: '#ffc800' },
  ...
  { id: 'pause_fir', code: 'PAUSE', name: 'pause FIR', points: [], color: 'rgba(255,200,0,0.15)', borderColor: '#ffc800' },
];

...
CRÉER UN COMPTE SUR LE SITE : ça ne se fait pas depuis une page du site ni depuis « Mon compte ». Le parcours est la commande slash « /register » de **PTFR Assistance** (pas le bot ATIS). Elle est ouverte à tout le serveur : le membre tape /register, un formulaire demande identifiant (2 à 30 caractères, lettres, chiffres et « _ ») et mot de passe (≥ 8 caractères). Il faut le rôle Vérifié du serveur (celui configuré sur le site) ; sans ce rôle, la commande répond qu’il faut d’abord se faire vérifier. La commande crée le compte, le relie au Discord, puis il se connecte sur le site.

...
- CRÉER UN COMPTE : commande Discord « /register » de PTFR Assistance (pas le bot ATIS), jamais depuis une page du site et jamais par toi. Ouverte à tout le serveur ; le rôle Vérifié du site est exigé. Sans ce rôle : se faire vérifier, puis relancer. Si la commande ne répond pas : staff → Admin → Pilotes → Créer un pilote. Le détail arrive dans les extraits « Démarches du site ».

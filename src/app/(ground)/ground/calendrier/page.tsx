...
export default async function GroundCalendrierPage() {
    ...
    <div className="space-y-6 p-4">
      <div className="flex items-start gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-slate-400 mt-1">UTC d’abord (19H UTC), heure locale entre parenthèses (7h Local).</p>
        </div>
      </div>

            ...
            {plan.pilote?.identifiant && (
              <div className="flex items-center gap-2 p-3 bg-slate-50 rounded-lg">
                ...
                <div>
                  ...
                  <p className="font-medium text-slate-800">{plan.pilote.identifiant}</p>
                </div>
              </div>
            )}
            ...
            {plan.compagnie?.nom && (
              <div className="flex items-center gap-2 p-3 bg-slate-50 rounded-lg">
                ...
                <div>
                  ...
                  <p className="font-medium text-slate-800">{plan.compagnie.nom}</p>
                </div>
              </div>
            )}
            
            {/* Avion */}
            {plan.avion?.immatriculation && (
              <div className="flex items-center gap-2 p-3 bg-slate-50 rounded-lg">
                <Plane className="h-5 w-5 text-slate-500" />
                <div>
                  <p className="text-xs text-slate-500">Avion</p>
                  <p className="font-medium text-slate-800 font-mono">{plan.avion.immatriculation}</p>
                  {plan.avion.nom_bapteme && <p className="text-xs text-slate-500">{plan.avion.nom_bapteme}</p>}
                </div>
              </div>
            )}
          </div>

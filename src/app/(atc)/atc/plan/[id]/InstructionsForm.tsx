...
export default function InstructionsForm({ planId, initial }: { planId: string; initial: string }) {
  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-2">
      ...
      <p className="text-slate-500 text-xs">Chaque ATC qui détient le plan peut modifier ou compléter les instructions de la position précédente (ex. Tower → APP).</p>

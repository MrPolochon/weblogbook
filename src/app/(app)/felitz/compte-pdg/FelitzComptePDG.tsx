...
import { Briefcase, Send, History, Plus, X } from 'lucide-react';
...
type Props = { compagnieId: string; compagnieNom: string; compteId: string; vban: string; solde: number };

export default function FelitzComptePDG({ compagnieId, compagnieNom, compteId, vban, solde: soldeInitial }: Props) {
  ...
  return (
    <div className="space-y-6">
      <div className="card">
        <h2 className="text-lg font-medium text-slate-200 mb-4">Mon compte - {compagnieNom}</h2>
        <div className="space-y-2">
          <div>
            <p className="text-slate-400 text-sm">VBAN entreprise</p>

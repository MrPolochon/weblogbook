...
import {
  ...
  ShieldCheck, XCircle, Plane,
  Inbox, Sparkles, ChevronDown, Award
} from 'lucide-react';
...
import IfsaAvionTab from './IfsaAvionTab';
import IfsaAutorisationsTab from './IfsaAutorisationsTab';
...
export default function IfsaClient({ signalements, enquetes, sanctions, pilotes, compagnies, compagniesAvecPilotes, pilotesChomage, agentsIfsa }: Props) {
  ...
  return (
    <div className="space-y-6">
      ...
      {activeTab === 'avion' && <IfsaAvionTab />}

      {activeTab === 'autorisations' && (
        <IfsaAutorisationsTab onPendingCountChange={setAutorisationsEnAttenteCount} />
      )}

...
import NotamsClient from './NotamsClient';
...
export default async function NotamsPage() {
  ...
  const [{ data: notams }, { data: profile }] = await Promise.all([
    supabase
      .from('notams')
      .select(
        'id, identifiant, code_aeroport, du_at, au_at, champ_a, champ_e, champ_d, champ_q, priorite, reference_fr, annule'
      )
      .eq('annule', false)
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-slate-400 text-sm max-w-2xl mt-1">
              ...
              Les NOTAMs restent affichés 3 jours après expiration puis sont supprimés. Voir le{' '}
              <a

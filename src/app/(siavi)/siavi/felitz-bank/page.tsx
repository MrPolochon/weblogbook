      ...
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-red-600 via-red-700 to-rose-800 p-6 shadow-xl">
        ...
        <div className="relative flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-red-100/80 text-sm">Votre compte personnel SIAVI</p>
          </div>
        </div>
      </div>
        ...
        {comptePerso ? (
          <div className="space-y-4">
            <div className="bg-red-50 rounded-lg p-4 border border-red-200">
              ...
              <p className="font-mono text-red-900 text-sm break-all">{comptePerso.vban}</p>
            </div>
          ...
          <p className="text-red-600">Aucun compte personnel trouvé.</p>
        )}
      </div>
    </div>
  );
